"""Train QR-DQN (distributional DQN) on SequentialDeliveryEnv."""
...
def main() -> None:
    ...
    parser.add_argument("--logdir", type=str, default="runs/qrdqn")
    ...
    model = QRDQN(
        ...
        policy_kwargs=dict(net_arch=[256, 256], n_quantiles=51),
    )
